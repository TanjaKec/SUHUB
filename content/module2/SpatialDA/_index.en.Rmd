...
Some RMarkdown reports that you will be able to do now with the knowledge from this course:

- https://tanjakec.github.io/ASDA/index.html

    * you can download necessary files from the following GitHub repo: <https://github.com/TanjaKec/ASDA>

- https://ohsa.netlify.app
