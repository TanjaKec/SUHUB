...
```{r}
#If you don't have the "DT" package installed yet, uncomment and run the line below
#install.packages("DT")
DT::datatable(fat)
```
...
In the multiple regression setting because of the potentially large number of predictors, it is more convenient to write the expressions using matrix notation. To develop the analogy let us quickly look at the matrix notation for the one variable linear regression function:
